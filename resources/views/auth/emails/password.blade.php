...
<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#e4e4e4">
    <tr>
        <td bgcolor="#e4e4e4" width="100%">
            ...
            <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="table">
                <tr>
                    <td width="600" class="cell">
                        ...
                        <table width="600" cellpadding="0" cellspacing="0" border="0" class="table">
                            <tr>
                                <td width="250" bgcolor="#e4e4e4" class="logocell">
                                    <img border="0"
                                         src="{{ asset('vendor/beautymail/assets/images/widgets/spacer.gif') }}"
                                         width="1" height="20" class="hide">
                                    <br class="hide">
                                    <img src="{{ asset('vendor/beautymail/assets/images/widgets/logo.png') }}"
                                         alt="uirEvents"
                        ...
                        <img border="0" src="{{ asset('vendor/beautymail/assets/images/widgets/spacer.gif') }}"
                        ...
                        <p>Your account have requested a password reset.</p>

                        <p>Click
                            <a href="{{ url('password/reset', $token).'?email='.urlencode($user->getEmailForPasswordReset()) }}">here</a>
            ...
            <img border="0" src="{{ asset('vendor/beautymail/assets/images/widgets/spacer.gif') }}" width="1"
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" width="220"
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                            <td><a href="https://twitter.com/MrShoodey"><img border="0"
                                                                                              src="{{ asset('vendor/beautymail/assets/images/widgets/twitter.gif') }}"
                                                                                              width="42" height="32"
                                                                                              alt="Follow us on Twitter"></a>
                                                            </td>

                                                            <td><a href="http://facebook.com/MrShoodey"><img border="0"
                                                                                               src="{{ asset('vendor/beautymail/assets/images/widgets/facebook.gif') }}"
                                                                                               width="32" height="32"
                                                ...
                                                <p style="color:#b3b3b3;font-size:11px;line-height:15px;font-family:Helvetica,Arial,sans-serif;margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:0;font-weight:bold;">UIR<strong>EVENTS</strong></p>
